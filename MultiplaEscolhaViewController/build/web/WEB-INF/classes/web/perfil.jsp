        ...
        <section id="process">  
            ...
            <div class="row">
                <div class="col s3">
                    ...
                    <a id="nomeUsuario"> <%= request.getAttribute("nomeUsuario")%> </a>
                    <h6 name="apelido"> <%= request.getAttribute("apelido")%> </h6>
                </div>
            ...
            <div class="row">
                <div class="col s3">
                    <p id="emailUsuario"> <%= request.getAttribute("emailUsuario")%> </p>
